...
function SkeletonRow() {
  return (
    <div className="dashboard__skeleton-row">
      ...
      <div className="skeleton-block" style={{ width: 80, height: 22, borderRadius: 6 }} />
      <div className="skeleton-block" style={{ width: 20, margin: "0 auto" }} />
      <div className="skeleton-block" style={{ width: 20, margin: "0 auto" }} />
      <div className="skeleton-block" style={{ width: 80, height: 28, borderRadius: 7, margin: "0 auto" }} />
    </div>
  );
}
...
export default function ComplianceDashboard() {
  ...
  const nbConformes = fournisseurs.filter((f) => f.statut === "conforme").length;
            ...
            >
              <div>
                ...
                <div className="dashboard__row-docs">
                  {f.nbDocuments} document{f.nbDocuments > 1 ? "s" : ""}
                </div>
              </div>

              <div className="dashboard__row-siret">{f.siret}</div>

              <div><StatusTag statut={f.statut} small /></div>
              ...
              <div>
                <button
                  ...
                  onClick={(e) => { e.stopPropagation(); navigate(`/fournisseur/${f.id}`); }}
                >
                  Détails →
                </button>
              </div>
